    ...
    switch (type?.toLowerCase()) {
      case "top-up-error":
        return {
          ...
          messageBody:
            "Your top-up didn’t go through. No worries! Please check your payment details and try again",
      ...
      default:
        return {
          message: "Error!",
          messageBody: "Something went wrong, but not to worry!",
          button1Text: "Go to dashboard",
          button2Text: "Try again",
          redirectUrl: "/dashboard",
        };
        ...
        <div className=" w-full max-w-full lg:max-w-[90%]">
          ...
          <div className="flex flex-col items-center justify-center text-center w-full mt-[15%] space-y-6">
            ...
            <div className="flex flex-col lg:flex-row w-full items-center justify-center space-x-5 space-y-5">
              ...
              >
                <span>{button2Text || "Try again"}</span>
              </PrimaryButton>
            </div>
